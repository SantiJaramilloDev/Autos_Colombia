      ...
      <div className="relative w-full max-w-md bg-[#0a0f1c]/60 backdrop-blur-2xl border border-blue-500/20 rounded-4xl p-8 shadow-[0_0_50px_-12px_rgba(59,130,246,0.3)] overflow-hidden animate-fade-in-up">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <form className="w-full space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-[#111827]/50 border border-blue-500/30 rounded-2xl py-4 pl-12 pr-4 text-white placeholder-blue-200/40 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-400 transition-all duration-300 shadow-inner"
                required
              />
            </div>
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-[#111827]/50 border border-blue-500/30 rounded-2xl py-4 pl-12 pr-12 text-white placeholder-blue-200/40 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400 transition-all duration-300 shadow-inner"
                required
              />
              <button
                type="button"
            ...
            <div className="flex justify-end w-full -mt-2">
              <a href="#" className="text-sm text-blue-400 hover:text-blue-300 transition-colors hover:underline decoration-blue-400/50 underline-offset-4">
            ...
            <button
              type="submit"
              className="relative w-full rounded-2xl overflow-hidden group mt-4 shadow-[0_0_20px_rgba(59,130,246,0.4)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] transition-shadow duration-300"
            >
          ...
          <p className="text-base text-blue-100/70">
            ...
            <Link to="/registro" className="text-blue-400 font-semibold hover:text-purple-400 transition-colors duration-300 hover:underline decoration-purple-400/50 underline-offset-4">
              Regístrate aquí
            </Link>
          </p>
